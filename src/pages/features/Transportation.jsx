...
const TransportationAssistant = () => {
  ...
  const handleAsk = () => {
    if (!question.trim()) {
      setError('Please enter a transportation-related question');
      return;
    }

    setAnswer('');
    setError('');
    fetchGroqResponse("Transportation Assistant:", question);
  };

  useEffect(() => {
    if (response) {
      const formatted = `# ${question}\n\n**Answered by ${website.name} AI**\n\n${response}`;
      setAnswer(formatted);
    }
  }, [response]);
      ...
      <div className="max-w-4xl mx-auto">
        <motion.div className="text-center mb-12">
          <h1 className="text-4xl font-extrabold tracking-tight sm:text-5xl mb-4" style={{ color: colors.primary }}>
            {website.name} Transportation Assistant
          </h1>
        ...
        <motion.div className="bg-gray-50 p-6 rounded-lg mb-8 shadow-sm">
          ...
          <ol className="list-decimal text-black pl-5 space-y-2">
            <li>Ask any transportation-related question (e.g., "What is a smart traffic system?")</li>
            <li>Click "Ask AI"</li>
            <li>View the AI-generated insight</li>
        ...
        <div className="mb-8">
          ...
          <div className="flex space-x-4">
            <input
              ...
              placeholder="e.g. How does public transit reduce emissions?"
        ...
        <motion.div className="bg-orange-50 p-6 rounded-lg border text-black border-orange-100">
          <h2 className="text-xl font-semibold mb-3">Tips for Asking Transportation Questions</h2>
          <ul className="list-disc pl-5 space-y-2">
            <li>Ask about public, private, or smart transport systems</li>
            <li>Explore logistics, traffic engineering, or sustainability topics</li>
            <li>Be specific about modes (road, rail, air, water, etc.)</li>
            <li>Mention goals like reducing emissions or improving speed</li>
          </ul>
        </motion.div>
      </div>
    </motion.div>
...
export default TransportationAssistant;
