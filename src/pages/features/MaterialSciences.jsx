...
const MaterialScienceAssistant = () => {
  ...
  const handleAsk = () => {
    if (!question.trim()) {
      setError('Please enter a material science question');
      return;
    }

    setError('');
    fetchGroqResponse('Materials Science', question); // Use custom hook to fetch the answer
  };
      ...
      <div className="max-w-4xl mx-auto">
        <motion.div className="text-center mb-12">
          <h1 className="text-4xl font-extrabold tracking-tight sm:text-5xl mb-4" style={{ color: colors.primary }}>
            {website.name} Materials Science Assistant
          </h1>
        ...
        <motion.div className="bg-gray-50 p-6 rounded-lg mb-8 shadow-sm">
          ...
          <ol className="list-decimal text-black pl-5 space-y-2">
            <li>Ask any materials science question (e.g., "What is tensile strength?")</li>
            <li>Click "Ask AI"</li>
        ...
        <div className="mb-8">
          <label htmlFor="question" className="block text-lg font-medium text-gray-700 mb-2">
            Ask a materials science question:
          </label>
          <div className="flex space-x-4">
            <input
              ...
              placeholder="e.g. What are the properties of graphene?"
        ...
        <motion.div className="bg-orange-50 p-6 rounded-lg border text-black border-orange-100">
          <h2 className="text-xl font-semibold mb-3">Tips for Asking Material Science Questions</h2>
          <ul className="list-disc pl-5 space-y-2">
            <li>Ask about properties, structures, or applications of materials</li>
            <li>Use specific terms like “ductility,” “ceramics,” or “crystalline lattice”</li>
            <li>Include context like usage in aerospace, biomedical, or electronics</li>
            <li>Keep your question clear and concise for best results</li>
          </ul>
        </motion.div>
      </div>
    </motion.div>
...
export default MaterialScienceAssistant;
