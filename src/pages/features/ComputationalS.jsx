...
const ComputationalScienceAssistant = () => {
  ...
  const handleAsk = () => {
    if (!question.trim()) {
      alert('Please enter a computational science question');
      return;
    }

    fetchGroqResponse('Computational science inquiry', question);  // Use the hook's method to fetch data
  };
      ...
      <div className="max-w-4xl mx-auto">
        <motion.div className="text-center mb-12">
          <h1 className="text-4xl font-extrabold tracking-tight sm:text-5xl mb-4" style={{ color: colors.primary }}>
            {website.name} Computational Science Assistant
          </h1>
        ...
        <motion.div className="bg-gray-50 p-6 rounded-lg mb-8 shadow-sm">
          ...
          <ol className="list-decimal text-black pl-5 space-y-2">
            <li>Ask any computational science question (e.g., "What is the finite difference method?")</li>
            <li>Click "Ask AI"</li>
        ...
        <div className="mb-8">
          <label htmlFor="question" className="block text-lg font-medium text-gray-700 mb-2">
            Ask a computational science question:
          </label>
          <div className="flex space-x-4">
            <input
              ...
              placeholder="e.g. What is Monte Carlo simulation?"
        ...
        <motion.div className="bg-orange-50 p-6 rounded-lg border text-black border-orange-100">
          <h2 className="text-xl font-semibold mb-3">Tips for Asking Computational Science Questions</h2>
          <ul className="list-disc pl-5 space-y-2">
            <li>Be specific (e.g., "Explain Runge-Kutta method in numerical integration")</li>
            <li>Use terminology from computer science, math, or physical simulations</li>
            <li>Ask about algorithms, equations, models, or code concepts</li>
            <li>Include your goal if asking about optimization or simulation</li>
          </ul>
        </motion.div>
      </div>
    </motion.div>
...
export default ComputationalScienceAssistant;
