...
const topic = {
  name: "EurekaAi",
  subdomain: "Household Math Advisor",
};
...
const HouseholdMath = () => {
  ...
  const { fetchGroqResponse, response, loading, error: groqError } = useGroq(); // Use the custom hook

  const handleAsk = async () => {
    if (!question.trim()) {
      setError('Please enter a household math-related question.');
      return;
    }
    ...
    // Call the Groq API via the custom hook
    await fetchGroqResponse("Household Math Advice", question);
  };
    ...
    >
      <div className="max-w-4xl mx-auto">
        <motion.div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600">Ask about home cleaning, kitchen math, eco-living, or DIY tips!</p>
        </motion.div>
        ...
        <motion.div className="bg-gray-50 p-6 rounded-lg mb-8 shadow-sm">
          ...
          <ol className="list-decimal text-black pl-5 space-y-2">
            <li>Type your household math question below.</li>
            <li>Click “Ask AI”.</li>
